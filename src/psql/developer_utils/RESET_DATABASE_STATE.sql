...
(
	...
	500, --STARTING_POPULATION_SIZE,
	80, --NUMBER_OF_RECENT_CONTENDERS,
	100, --NUMBER_OF_RANDOM_CONTENDERS,
...
BEGIN
	...
	SELECT
		...
		+ (RANDOM())*(RANDOM()-.5) * (ABS(PAR_ALPHA.PARAMETER_VALUE - PAR_BETA.PARAMETER_VALUE)+0.0001)
...
CREATE OR REPLACE FUNCTION RECORD_EXPERIMENT_RESULT(EXPERIMENT_ID BIGINT, SCORE DOUBLE PRECISION, DATA TEXT) RETURNS VOID
AS
$$
BEGIN
	INSERT INTO RESULT
