...
BEGIN
	...
	EXPERIMENT_ID = GET_NEXT_EXPERIMENT_FOR_GROUP(EXPERIMENT_GROUP_ID);
...
CREATE OR REPLACE FUNCTION GET_NEXT_EXPERIMENT_FOR_GROUP(PARAM_EXPERIMENT_GROUP_ID BIGINT) RETURNS BIGINT
AS 
$$
DECLARE EXPERIMENT_ID BIGINT;
BEGIN
